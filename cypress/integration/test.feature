...
Then I do Verify the Correct Text 'Correct Format' Should be Displayed 
...
#Note:
We can create more Scenarios by Providing Invalid Data, Empty Data for above Feature using Sort, Filter & Search Options due to Limited time Created ABove Scenarios.